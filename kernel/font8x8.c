...
/* 8x8 bitmap font, ASCII 0x20-0x7E, derived from the classic Linux console
 * VGA 8x8 font (kbd package, Lat2-VGA8.psf). Each byte is one glyph row,
 * MSB = leftmost pixel. */
const uint8_t font8x8[95][8] = {
    ...
    {0xE0,0x60,0x60,0x60,0x60,0x68,0x30,0x00}, /* l */
